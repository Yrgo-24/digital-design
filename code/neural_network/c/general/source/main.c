...
/**
 * @brief Create vector holding input sets for training of the neural network.
 * 
...
/**
 * @brief Create vector holding output sets for training of the neural network.
 * 
...
/**
 * @brief Create and initializes a small neural network, which is trained to 
