...
/**
 * @brief Dynamically allocate a one-dimensional vector of doubles.
 * 
...
/**
 * @brief Delete one-dimensional vector and frees all allocated memory.
 * 
...
/**
 * @brief Dynamically allocate a two-dimensional vector of doubles with 
...
/**
 * @brief Delete two-dimensional vector and frees all allocated memory.
 * 
...
/**
 * @brief Print content held by one-dimensional vector.
 * 
...
/**
 * @brief Print the content of a two-dimensional double vector, row by row.
 * 
