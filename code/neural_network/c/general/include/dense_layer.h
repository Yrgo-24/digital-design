...
/**
 * @brief Delete dense layer by freeing allocated resources.
 * 
...
/**
 * @brief Get the outputs of the dense layer.
 * 
...
/**
 * @brief Get the bias of each node in the dense layer.
 * 
 * @param self Pointer to the dense layer.
 * 
...
/**
 * @brief Get the activation function used for the dense layer.
 * 
 * @param self Pointer to the dense layer.
 * 
...
/**
 * @brief Perform feedforward with given input.
 * 
 * @param self        Pointer to the dense layer.
...
/**
 * @brief Perform backpropagation for output layer with given reference values.
 * 
 * @param self            Pointer to the dense layer.
...
/**
 * @brief Perform backpropagation for hidden layer with next connected layer.
 * 
 * @param self       Pointer to the dense layer.
...
/**
 * @brief Print dense layer parameters.
 * 
 * @param self    Pointer to the dense layer.
