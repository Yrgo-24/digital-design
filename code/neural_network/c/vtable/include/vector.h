...
{
    /***
     * @brief Get the data held by vector.
     * 
    ...
    /***
     * @brief Indicate if vector is of arithmetic type.
     * 
     * @param self Pointer to the vector.
     * 
...
/***
 * @brief Delete vector and frees all allocated memory.
 * 
