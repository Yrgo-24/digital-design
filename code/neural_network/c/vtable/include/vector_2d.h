...
{
    /***
     * @brief Get the data held by two-dimensional vector.
     * 
    ...
    /***
     * @brief Get the size of two-dimensional vector.
     * 
     * @param self Pointer to the two-dimensional vector.
     * 
    ...
    /***
     * @brief Get the start of two-dimensional vector.
     * 
     * @param self Pointer to the two-dimensional vector.
     * 
    ...
    /***
     * @brief Get the end of two-dimensional vector.
     * 
     * @param self Pointer to the two-dimensional vector.
     * 
    ...
    /**
     * @brief Print content held by two-dimensional vector.
     * 
     * @param self    Pointer to the two-dimensional vector.
...
/***
 * @brief Create new two-dimensional vector.
 * 
