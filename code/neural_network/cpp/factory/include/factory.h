...
/**
 * @brief Create and initializes one-dimensional parameter vector.
 * 
...
/**
 * @brief Create and initializes two-dimensional parameter vector.
 * 
...
/**
 * @brief Create one-dimensional parameter vector initialized with randomly 
...
/**
 * @brief Create two-dimensional parameter vector initialized with randomly 
