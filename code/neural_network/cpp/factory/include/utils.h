...
/**
 * @brief Generate a random number in the range of specified min and max values.
 * 
...
/**
 * @brief Initialize one-dimensional vector with random numbers.
 * 
...
/**
 * @brief Initialize two-dimensional vector with random numbers.
 * 
 * @tparam T The vector type.
 * 
 * @param vector      Reference to the vector to initialize.
...
/**
 * @brief Print content of one-dimensional vector.
 * 
 * @tparam T The vector type.
 * 
...
/**
 * @brief Print content of two-dimensional vector.
 * 
 * @tparam T The vector type.
 * 
 * @note This function only works for arithmetic types and strings.
...
/**
 * @brief Get the sum of an arbitrary amount of numbers.
 * 
...
/**
 * @brief Get the difference of an arbitrary amount of numbers.
 * 
 * @tparam T       The type of the numbers.
 * @tparam Numbers Value type for parameter pack.
 * 
...
/**
 * @brief Get the product of an arbitrary amount of numbers.
 * 
 * @tparam T       The type of the numbers.
 * @tparam Numbers Value type for parameter pack.
 * 
...
/**
 * @brief Get the quotient of specified numbers.
 * 
...
/**
 * @brief Round floating-point number to the nearest integer.
 * 
...
/**
 * @brief Get the Rectified Linear Unit (ReLU) activation for a given input.
 * 
...
/**
 * @brief Get the gradient of the Rectified Linear Unit (ReLU) function for a given input.
 * 
...
/**
 * @brief Get the hyperbolic tangent (tanh) for a given input.
 * 
...
/**
 * @brief Get the gradient of the hyperbolic tangent (tanh) for a given input.
 * 
...
/**
 * @brief Indicate if specified type T is of string type.
 *
...
/**
 * @brief Declare const char* a valid string type.
 */
template<>
...
/**
 * @brief Declare char* a valid string type.
 */
template<>
...
/**
 * @brief Declare std::string a valid string type.
 */
template<>
