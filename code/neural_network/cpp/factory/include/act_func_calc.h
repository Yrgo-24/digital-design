...
public:
    ...
    /**
     * @brief Create new activation function calculator.
     * 
    ...
    /**
     * @brief Delete activation function calculator.
     */
    ~ActFuncCalc() = default;

    /**
     * @brief Get the type of activation function used for the calculations.
     * 
    ...
    /**
     * @brief Get the activation function output for a given input.
     *
    ...
    /**
     * @brief Get the activation function gradient for a given input.
     *
    ...
    /**
     * @brief Get the name of the activation function used for the calculations
     *        as a string.
     * 
